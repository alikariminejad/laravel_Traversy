<x-layout>
    <x-slot name="title">Edit the Job Listing</x-slot>
    <div
...
>
    ...
    <form method="POST" action="{{route('jobs.update', $job->id)}}" enctype="multipart/form-data">
        ...
        <x-inputs.text id="tags" name="tags" label="Tags (comma-separated)" placeholder="developement, coding, java, python" :value="old('tags', $job->tags)" />
        ...
        <x-inputs.text id="zipcode" name="zipcode" label="Zipcode" placeholder="11111" :value="old('zipdode', $job->zipcode)" />
        ...
        <x-inputs.text id="company_website" name="company_website" label="Company Website" placeholder="Enter Company Website" type="url" :value="old('company_website', $job->company_website)" />
        ...
        <x-inputs.text id="contact_email" name="contact_email" label="Contact Email" placeholder="Enter Contact Email" type="email" :value="old('contact_email', $job->contact_email)" />
