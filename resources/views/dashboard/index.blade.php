<x-layout>
    <section class="flex flex-col md:flex-row gap-4">
        ...
        <div class="bg-white p-8 rounded-lg shadow-md w-full">
            ...
            <button type="submit" class="w-full bg-green-500 hover:bg-green-600 text-white px-4 py-2 focus:outline-none">Save</button>
            </form>
        </div>
    ...
    <div class="bg-white p-8 rounded-lg shadow-md w-full">
        ...
        <div class="flex justify-between items-center border-b-2 border-gray-200 py-2">
            ...
            <div class="flex space-x-3">
                ...
                <!-- Delete Form -->
                <form method="POST" action="{{route('jobs.destroy', $job->id)}}?form=dashboard" onsubmit="return confirm('Are you sure you want to delete this job?')">
                    @csrf
                    @method('DELETE')
        ...
        @empty
        <p class="text-gray">You have no job listings</p>
        @endforelse
    </div>
</section>
